...
namespace ExpensesTracker.Controllers
{
    ...
    {
        private readonly ExpensesTrackedDb _context;

        public CategoryController(ExpensesTrackedDb context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ExpensesTrackedDb.Categories'  is null.");
            }
            var category = await _context.Categories.FindAsync(id);
            if (category != null)
            {
